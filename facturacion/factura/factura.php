...
<div id="page_pdf">
		...
		<tr>
			...
			<td class="info_empresa">
				...
				<div>
					...
					<p>NIF: <?php echo $configuracion['nif']; ?></p>
			...
			<td class="info_factura">
				<div class="round">
					<span class="h2">__Factura________________</span>
			...
			<td class="info_cliente">
				<div class="round">
					...
					<table class="datos_cliente">
						<tr>
							<td><label>Nif:</label><p><?php echo $factura['nif']; ?></p></td>
	...
	<div>
		<p class="nota">Si usted tiene preguntas sobre esta factura, <br>pongase en contacto con ELENE, tlf: 54321156, Email: elene@gmail.com</p>
