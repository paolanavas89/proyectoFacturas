			...
			<?php } ?>
				<li class="principal">
					...
					<ul>
						...
						<li><a href="lista_clientes.php"><i class="fas fa-list-alt"></i> Lista de Clientes</a></li>
					</ul>
				</li>
				<?php 
				...
				<li class="principal">
					...
					<ul>
						<li><a href="nueva_factura.php"><i class="fas fa-plus"></i> Nueva Factura</a></li>
						<li><a href="facturas.php"><i class="far fa-newspaper"></i> Facturas</a></li>
					</ul>
				</li>
			</ul>
		</nav>